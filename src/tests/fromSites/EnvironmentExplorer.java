...
public class EnvironmentExplorer extends JApplet implements
    ...
    String outFileBase = "res/images/Arizona.jpg";
     ...
     * MazeBackgroundSound 1: PointSound 2: ConeSound
     */
    void setupSounds() {
...
class BackgroundTool implements Java3DExplorerConstants {
    ...
    BackgroundTool(String codeBaseString) {
        ...
        try {
            bgImageURL = new java.net.URL(codeBaseString + "res/images/Arizona.jpg");
        } catch (java.net.MalformedURLException ex) {
            System.out.println(ex.getMessage());
            System.exit(1);
        }
        if (bgImageURL == null) { // application, try file URL
            try {
                bgImageURL = new java.net.URL("res/images/Arizona.jpg");
            } catch (java.net.MalformedURLException ex) {
                System.out.println(ex.getMessage());
                System.exit(1);
            }
